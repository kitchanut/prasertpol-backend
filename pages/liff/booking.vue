<template>
  <v-card>
    ...
    >
      ...
      <v-card-title primary-title> แจ้งข้อมูลการจอง</v-card-title>
...
export default {
  ...
  mounted() {
    this.initializeLiff(process.env.liff.booking);
  },
  methods: {
    async checkUserLine() {
      let data = {
    ...
    async onAction(id) {
      if (this.$refs.form.validate()) {
        ...
        const response = await apiRequestBook.store(formData);
        console.log(response.data);
        ...
        if (response.status == 200) {
          ...
          var Messages = [
            {
              type: "text",
              text: "แจ้งการจอง: " + response.data.car_no,
            },
            {
              type: "flex",
              altText: "แจ้งการจอง: " + response.data.car_no,
              contents: {
                type: "bubble",
                hero: {
                  type: "image",
                      ...
                      contents: [
                        ...
                        },
                        {
                          ...
                          contents: [
                            ...
                            {
                              type: "text",
                              text: response.data.hear_from_type,
                              wrap: true,
                              color: "#666666",
                              size: "sm",
                              flex: 5,
                        ...
                        },
                        {
                          ...
                          contents: [
                            ...
                            {
                              type: "text",
                              text: response.data.booking_fee + " บาท",
                              wrap: true,
                              color: "#666666",
                              size: "sm",
                              flex: 5,
                  ...
                  contents: [
                    ...
                    },
                    {
                      ...
                      action: {
                        type: "uri",
                        label: "รูปสลิป",
                        uri: this.serverUrl + response.data.booking_slip,
                      },
                    },
                    {
                      type: "button",
                    ...
                    },
                    {
                      ...
                      action: {
                        ...
                        uri:
                          ...
                          `?type=booking&id=${response.data.id}`,
                      },
                    },
                    {
                      type: "box",
    ...
    runApp() {
      liff.getProfile().then(async (profile) => {
        ...
        this.formData.request_booking_status = "pedding";
