...
export default {
  ...
  mounted() {
    this.initializeLiff(process.env.liff.bankApprove);
  },
  methods: {
    async checkUserLine() {
      let data = {
      ...
      if (this.$refs.form.validate()) {
        ...
        if (response.status == 200) {
          ...
          var Messages = [
            {
              type: "text",
              text: "แจ้งแบงค์อนุมัติ: " + response.data.car_no,
            },
            {
              type: "flex",
              altText: "แจ้งแบงค์อนุมัติ: " + response.data.car_no,
              contents: {
                type: "bubble",
                hero: {
                  type: "image",
                      ...
                      contents: [
                        ...
                        },
                        {
                          ...
                          contents: [
                            ...
                            {
                              type: "text",
                              text: response.data.approve_date,
                              wrap: true,
                              color: "#666666",
                              size: "sm",
                              flex: 5,
                    ...
                    },
                    {
                      ...
                      action: {
                        ...
                        uri:
                          ...
                          `?type=bankApprove&id=${response.data.id}`,
                      },
                    },
                    {
                      type: "box",
