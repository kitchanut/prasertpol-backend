    ...
    <v-card>
      ...
      >
        <template v-slot:[`item.customer_job`]="{ item }">
          ...
          <h5 v-else-if="item.customer_job == '2'" class="blue--text">
            พนักงานเอกชน
          </h5>
          <h5 v-else-if="item.customer_job == '3'" class="green--text">
            เกษตรกรกร
          </h5>
          <h5 v-else-if="item.customer_job == '4'" class="pink--text">
            ค้าขาย
          </h5>
          <h5 v-else-if="item.customer_job == '5'" class="purple--text">
            อื่น ๆ
          </h5>
