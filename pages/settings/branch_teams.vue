...
import dialogNew from "@/components/dialog/dialogBranchTeam";
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "ชื่อทีม", value: "branch_team_name", width: "15%" },
        { text: "สถานะ", value: "branch_team_active", width: "5%" },
  ...
  methods: {
    ...
    async deleteItem(id) {
      ...
      await isConfirmed.then((result) => {
        if (result == true) {
          const respone = apiBranch_teams.destroy(id);
