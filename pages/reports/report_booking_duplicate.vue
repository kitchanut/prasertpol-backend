    ...
    <v-card>
      <v-card-text>
        ...
        >
          ...
          <template v-slot:[`item.cars.car_gear`]="{ item }">
            <h5 v-if="item.cars.car_gear == '1'" class="green--text">AT</h5>
            <h5 v-if="item.cars.car_gear == '2'" class="orange--text">MT</h5>
          </template>
        </v-data-table>
      </v-card-text>
    </v-card>
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {
          text: "ประเภท",
          value: "cars.car_types.car_type_name",
          class: "textOneLine",
        },
        {
          text: "ค่ายรถ",
        ...
        {
          text: "จัด",
          value: "cars.amount_price",
          class: "textOneLine",
        },
        {
          text: "ดาวน์",
          value: "cars.amount_down",
          class: "textOneLine",
        },
        {
          text: "ขาย",
          value: "cars.car_price_vat",
          class: "textOneLine",
        },
        {
          text: "ราคาสุทธิ",
          value: "cars.net_price",
          class: "textOneLine",
        },
        {
          text: "ทะเบียน (เก่า)",
  ...
  methods: {
    ...
    async getData() {
      ...
      const response = await apiReport.report_booking_duplicate(data);
