          ...
          <v-card-text>
            ...
            <v-row no-gutters>
              <v-col cols="3" class="pr-2">
                <v-card>
                  <v-card-title class="primary--text"> ข้อมูลรถ </v-card-title>
                  <v-card-text>
                    <v-text-field
                      autocomplete="true"
                      label="ลำดับรถ"
              ...
              <v-col cols="3" class="pl-2">
                <v-card>
                  <v-card-title class="primary--text"> ข้อมูลฝ่ายขาย </v-card-title>
                  <v-card-text>
                    <v-text-field label="Sale" v-model="formData.first_name" outlined dense hide-details readonly>
                    </v-text-field>
                ...
                <v-card class="mt-4">
                  <v-card-title class="primary--text"> วันที่ </v-card-title>
                  <v-card-text>
                    <v-menu
              ...
              <v-col cols="6" class="pl-4">
                <v-card>
                  <v-card-title class="primary--text"> ราคากลาง </v-card-title>
                  <v-card-text>
                    <v-row no-gutters>
                      <v-col cols="5 pr-2">
                        <v-text-field
                ...
                <v-card class="mt-3">
                  <v-card-title class="primary--text"> ดอกเบี้ย </v-card-title>
                  <v-card-text>
                    <v-row no-gutters>
                      <v-col cols="6 pr-2">
                        <v-text-field
                    ...
                    <v-row no-gutters class="mt-3">
                      ...
                      <v-col cols="6 pl-2">
                        <v-text-field label="ประกันภัยประเภท" v-model="formData.insurance" outlined dense hide-details>
                        </v-text-field>
                      </v-col>
                    </v-row>
                  </v-card-text>
            ...
            <v-card class="mt-3">
              <v-card-title class="primary--text"> เอกสารแนบ </v-card-title>
              <v-card-text>
                <v-file-input
                  class="mt-3"
            ...
            <v-row class="mt-1">
              <v-col>
                <v-card>
                  <v-card-title class="primary--text"> ข้อมูลผู้ซื้อ </v-card-title>
                  <v-card-text>
                    <v-row class="d-flex flex-row">
                      <v-col cols="7">
                        <v-text-field
                    ...
                    >
                      ...
                      <v-col cols="5" v-if="formData.customer_job == 5">
                        <v-text-field
                          autocomplete="true"
                          label="อาชีพ"
              ...
              <v-col>
                <v-card>
                  <v-card-title class="primary--text"> ข้อมูลผู้ค้ำ </v-card-title>
                  <v-card-text>
                    <v-row class="d-flex flex-row">
                      <v-col>
                        <v-text-field
                    ...
                    >
                      ...
                      <v-col cols="12" v-if="formData.customer_refer_job == 5">
                        <v-text-field
                          autocomplete="true"
                          label="อาชีพ"
                ...
                <v-card class="mt-3">
                  <v-card-title class="primary--text"> ข้อมูลรถตีเทริ์น </v-card-title>
                  <v-card-text>
                ...
                <!-- <v-card class="mt-3">
                  <v-card-title class="primary--text"> ทราบข่าว </v-card-title>
                  <v-card-text>
                    <v-row
                      class="d-flex flex-row rounded ma-auto"
                      style="border-style: solid; border-width: 1px; border-color: gray"
                    >
                      <v-col>
                        <v-radio-group
                        ...
                        >
                          ...
                          <v-radio value="7" label="ออไลน์"></v-radio>
                ...
                <v-card class="mt-3">
                  <v-card-title class="primary--text"> ค่าคอม </v-card-title>
                  <v-card-text>
                    <v-row class="d-flex flex-row">
                      <v-col>
                        <v-text-field
                    ...
                    <v-row class="d-flex flex-row mt-0">
                      <v-col>
                        <v-text-field
                          autocomplete="true"
                          label="ครั้งที่"
            ...
            <v-row>
              <v-col>
                <v-card>
                  <v-card-title class="primary--text"> รายละเอียดเพิ่มเติม </v-card-title>
                  <v-card-text>
                    <v-row class="d-flex flex-row">
                      <v-col>
                        <v-menu
              ...
              <v-col>
                <v-card>
                  <v-card-title class="primary--text"> สิ่งที่ต้องมีก่อนปล่อยให้ลูกค้า </v-card-title>
                  <v-card-text>
                    <v-row class="d-flex flex-row">
                      <v-col>
                        <v-textarea
                    ...
                    <v-radio-group v-model="formData.sign_tex" row class="mt-3" hide-details>
                      <template>
                        <div class="ml-3 mr-3">1.ป้ายภาษี:</div>
                      </template>
                      <v-radio value="1" label="มี"></v-radio>
                      <v-radio value="2" label="ไม่มี"></v-radio>
                    </v-radio-group>
                    <v-radio-group v-model="formData.act" row class="mt-3" hide-details>
                      <template>
                        <div class="ml-3 mr-10">2.พรบ:</div>
                      </template>
                      <v-radio value="1" label="มี"></v-radio>
                      <v-radio value="2" label="ไม่มี"></v-radio>
                    </v-radio-group>
                    <v-radio-group v-model="formData.manual" row class="mt-3" hide-details>
                      <template>
                        <div class="ml-3 mr-3">3.หน้าเล่มคู่มือ:</div>
                      </template>
                      <v-radio value="1" label="มี"></v-radio>
                      <v-radio value="2" label="ไม่มี"></v-radio>
                    </v-radio-group>
                    <v-radio-group row v-model="formData.number_peel" class="mt-3" hide-details>
                      <template>
                        <div class="ml-3 mr-4">4.เลขลอก:</div>
                      </template>
                      <v-radio value="1" label="มี"></v-radio>
                      <v-radio value="2" label="ไม่มี"></v-radio>
                    </v-radio-group>
                    <v-radio-group v-model="formData.sign_license" row class="mt-3" hide-details>
                      <template>
                        <div class="ml-3 mr-4">5.ทะเบียน:</div>
                      </template>
                      <v-radio value="1" label="มี"></v-radio>
                      <v-radio value="2" label="ไม่มี"></v-radio>
                    </v-radio-group>
