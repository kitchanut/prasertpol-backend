          ...
          <v-container>
            <v-card-text>
              ...
              <v-row class="d-flex flex-row">
                ...
                <v-col>
                  <h6 class="mt-1" style="font-size: inherit">ตกลงขายรถยนต์</h6>
                </v-col>
              </v-row>
              ...
              <v-row no-gutters class="d-flex flex-row pt-3">
                <v-col>
                  <v-text-field
                    autocomplete="true"
                    label="เงินดาวน์หรือเงินซื้อสดที่ได้รับวันปล่อยรถ"
                    type="number"
                    min="0"
              ...
              <div style="background-color: #d9d9d9" class="pa-2 mt-1">
