<template>
  <div>
    <v-dialog v-model="dialogComponent" fullscreen hide-overlay transition="dialog-bottom-transition">
      <v-card tile style="position: relative; background-color: #eee">
        <v-form ref="form" lazy-validation>
          ...
          <v-card>
            <div class="text-center pt-3" style="font-size: 20px; font-weight: 500">ใบสำคัญรับเงินทั้งหมด</div>
            ...
            <table class="bordered mt-3">
              <thead>
                <tr>
                  ...
                  <th width="8%" style="border-left: 1px solid rgba(0, 0, 0, 0.2); padding: 10px 3px; text-align: left">
                    ประเภท
                  </th>
                  <th width="12%" style="border-left: 1px solid rgba(0, 0, 0, 0.2); padding: 3px; text-align: left">
                    วันที่
                  </th>
                  <th width="15%" style="border-left: 1px solid rgba(0, 0, 0, 0.2); padding: 3px; text-align: left">
                    ลูกค้า
                  </th>
                  <!-- <th
                    width="10%"
                  ...
                  <th width="15%" style="border-left: 1px solid rgba(0, 0, 0, 0.2); padding: 3px; text-align: right">
                    จำนวน
                  </th>
                  <th
                    width="5%"
              ...
              <tbody>
                <tr style="line-height: 1rem; font-size: 1rem" v-for="(item, key) in data" :key="key">
                  ...
                  >
                    ...
                    <div v-else-if="item.payment_type == 4">ค่างวดล่วงหน้า</div>
                    <div v-else-if="item.payment_type == 5">สมาร์ทชัว</div>
                    <div v-else-if="item.payment_type == 6">ประกันอื่นๆ</div>
                    <div v-else-if="item.payment_type == 99">อื่นๆ</div>
                    <div v-else>N/A</div>
                  </td>
                  <td
                    style="
            ...
            <v-btn class="mt-3" text color="primary" @click="Financial(car_no, idWork, '2', 'add')">
