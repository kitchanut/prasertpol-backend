...
- `<BarChart>` | `<bar-chart>` (components/BarChart/index.vue)
...
- `<DashboardComFiles>` | `<dashboard-com-files>` (components/Dashboard/ComFiles.vue)
...
- `<DashboardComSaleCompare>` | `<dashboard-com-sale-compare>` (components/Dashboard/ComSaleCompare.vue)
- `<DashboardComTopSaler>` | `<dashboard-com-top-saler>` (components/Dashboard/ComTopSaler.vue)
...
- `<PieChartChannel>` | `<pie-chart-channel>` (components/PieChart/Channel.vue)
